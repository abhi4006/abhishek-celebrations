...
function CoverPage({ onOpen }: { onOpen: () => void }) {
  return (
    ...
    >
      ...
      >
        हमारे सुपुत्र अभिषेक के मंगल उत्सव की शुभ बेला में
        <br />
    ...
    >
      <motion.header variants={pageItem}>
        ...
        <p className="event-copy">
          हमारे सुपुत्र अभिषेक एवं कंचन के सगाई समारोह में
          <br />
  ...
  return (
    <main className="invitation-page">
      ...
      <motion.article
        ...
        aria-label="अभिषेक के परिवार की ओर से मंगल उत्सव निमंत्रण"
      >
        <ShehnaiPlayer />
